...
if (file_exists($pathControlFile)){
    echo '<a href="'.$pathControlFile.'" target="_blank"><p class="infoP">Alle Worte ohne Widerholung (Kontrolle)</p></a>';
}else{
    echo '<p class="infoP">Kontroll-Datei nicht gefunden</p>';
}

if (file_exists($pathFinalFile)){
    echo '<a href="'.$pathFinalFile.'" target="_blank"><p class="infoP">Datei mit Wiederholungen</p></a>';
}else{
